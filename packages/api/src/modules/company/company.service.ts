            ...
            const result = await prisma.$transaction(async (tx) => {
                ...
                const updatedUser = await tx.user.update({
                    ...
                    data: {
                        ...
                        role: "COMPANY", // Asumiendo que el usuario que crea la compañía debe tener rol COMPANY
                        updatedAt: new Date(),
                    },
                });
    ...
    async updateCompany(companyId: string, userId: string, data: {
        ...
        try {
            ...
            if (user.role !== "COMPANY") {
                throw new Error("Solo los administradores de la compañía pueden actualizarla");
            }
