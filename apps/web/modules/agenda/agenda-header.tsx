              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{formatTime(company.startTime, company.pmamStart)} - {formatTime(company.endTime, company.pmamEnd)}</p>
                  </div>
                  <div>
                    <p className="text-lg font-semibold text-foreground">
                      Ubicación
                    ...
                    <Link href={company.mapsLocation} target="_blank" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{formatAvailableDays(company.availableDays)}</p>
                  </div>
                  <div>
                    <p className="text-lg font-semibold text-foreground">
                      Contacto
